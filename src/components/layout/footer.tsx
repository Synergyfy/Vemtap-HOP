        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["Features", "HMO Management", "Optical Workflow", "Queue Automation", "Pricing", "API"].map((item) => (
                <li key={item}><Link href="#" className="text-sm text-slate-500 hover:text-brand-blue transition-colors">{item}</Link></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["Documentation", "Help Center", "Blog", "Case Studies", "Status", "Contact"].map((item) => (
                <li key={item}><Link href="#" className="text-sm text-slate-500 hover:text-brand-blue transition-colors">{item}</Link></li>
              ))}
            </ul>
          </div>
